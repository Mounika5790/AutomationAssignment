...
public class APITest {
	...
	public static void test1() {
		...
		// to convert the response string to Json format
	...
	public void test2() {
		...
		body("\"external_id\": \"Interview15675675676767675 \",\"name\": \"Interview Station12121\", \"latitude\": 33.44,\"longitude\": -12.44,\"altitude\": 444").when().post("//data/2.5/weather").then().assertThat().log().all().statusCode(201).extract().response().asString();
